  ...
  [5],
  {
    nRki: function (e, a, t) {
      ...
      const s = i.d.div.withConfig({
        ...
        e => {
          let { theme: a } = e;
          return a.mixins.flexCenter;
        },
      );
      a.default = e => {
        let { location: a, data: t } = e;
        const i = t.allMarkdownRemark.edges,
          p = Object(r.useRef)(null),
          h = Object(r.useRef)(null),
          f = Object(r.useRef)([]);
        return (
          Object(r.useEffect)(() => {
            c.a.reveal(p.current, Object(d.srConfig)()),
              c.a.reveal(h.current, Object(d.srConfig)(200, 0)),
              f.current.forEach((e, a) => c.a.reveal(e, Object(d.srConfig)(10 * a)));
          }, []),
          l.a.createElement(
            o.i,
            { location: a },
            l.a.createElement(n.a, { title: 'Archive' }),
            l.a.createElement(
              'main',
              null,
              l.a.createElement(
                'header',
                { ref: p },
                l.a.createElement('h1', { className: 'big-heading' }, 'Archive'),
                l.a.createElement(
                  'p',
                  { className: 'subtitle' },
                ...
                l.a.createElement(
                  ...
                  l.a.createElement(
                    ...
                    l.a.createElement(
                      'tr',
                      null,
                      l.a.createElement('th', null, 'Year'),
                      l.a.createElement('th', null, 'Title'),
                      l.a.createElement('th', { className: 'hide-on-mobile' }, 'Made at'),
                      l.a.createElement('th', { className: 'hide-on-mobile' }, 'Built with'),
                      l.a.createElement('th', null, 'Link'),
                    ),
                  ),
                  l.a.createElement(
                    'tbody',
                    ...
                    i.length > 0 &&
                      i.map((e, a) => {
                        ...
                        return l.a.createElement(
                          'tr',
                          { key: a, ref: e => (f.current[a] = e) },
                          l.a.createElement(
                            'td',
                            { className: 'overline year' },
                            '' + new Date(r).getFullYear(),
                          ),
                          l.a.createElement('td', { className: 'title' }, o),
                          l.a.createElement(
                            'td',
                            { className: 'company hide-on-mobile' },
                            p
                              ? l.a.createElement('span', null, p)
                            ...
                            s.length > 0 &&
                              s.map((e, a) =>
                                l.a.createElement(
                                  ...
                                  '',
                                  a !== s.length - 1 &&
                                    l.a.createElement('span', { className: 'separator' }, '·'),
                                ),
                              ),
                          ),
                          l.a.createElement(
                            ...
                            l.a.createElement(
                              ...
                              i &&
                                l.a.createElement(
                                  ...
                                  l.a.createElement(m.a, { name: 'External' }),
                                ),
                              n &&
                                l.a.createElement(
                                  'a',
                                  { href: n, 'aria-label': 'GitHub Link' },
                                  l.a.createElement(m.a, { name: 'GitHub' }),
                                ),
                              d &&
                                l.a.createElement(
                                  'a',
                                  { href: d, 'aria-label': 'Apple App Store Link' },
                                  l.a.createElement(m.a, { name: 'AppStore' }),
                                ),
                              c &&
                                l.a.createElement(
                                  'a',
                                  { href: c, 'aria-label': 'Google Play Store Link' },
                                  l.a.createElement(m.a, { name: 'PlayStore' }),
                                ),
                            ),
                          ),
                        );
...
//# sourceMappingURL=component---src-pages-archive-js-128c6c97d25a284487f7.js.map
